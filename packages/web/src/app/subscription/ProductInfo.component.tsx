...
export default function ProductInfoComponent({ duck }: ProductInfoProps) {
    return (
        <div className="px-4 sm:px-0">
            {" "}
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">{duck.name}</h1>
            <div className="mt-3">
                <p className="text-3xl tracking-tight text-gray-900">{Utils.price.display(duck.price)} per Month</p>
            </div>
